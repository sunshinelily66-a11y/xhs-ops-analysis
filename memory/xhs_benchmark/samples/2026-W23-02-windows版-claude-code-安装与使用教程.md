...
date_seen: 2026-W23
source_url: https://www.xiaohongshu.com/explore/687f3794000000001d00c909
platform: xiaohongshu
topic: "www.xiaohongshu.com/explore" "Claude Code"
...
- title: Windows版 Claude Code 安装与使用教程
- cover_text: unknown
- cover_structure: unknown
- body_structure: unknown
- visible_metrics: unknown
- comment_signals: unknown
- search_snippet: 页面引用“Windows版Claude Code安装与使用教程（小红书）”，并给出小红书 explore 链接。
- candidate_reason: 初学者安装教程型内容，和“纯小白如何开始使用 AI 编程工具”的账号方向匹配。
- candidate_index: 2
- benchmark_weight: low_to_medium
- sample_role: tutorial_utility_reference
